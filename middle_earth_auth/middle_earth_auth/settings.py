"""
Django settings for middle_earth_auth project.
...
from middle_earth_auth import db_config
from middle_earth_auth.secret_key import get_secret_value
...
SECRET_KEY = get_secret_value('auth_secret_key')
...
ALLOWED_HOSTS = ['middleearthauth', '127.0.0.1', 'localhost']
...
INSTALLED_APPS = [
    ...
    'middle_earth_auth_app.apps.MiddleEarthAuthAppConfig',
]
...
ROOT_URLCONF = 'middle_earth_auth.urls'
...
WSGI_APPLICATION = 'middle_earth_auth.wsgi.application'
...
AUTH_USER_MODEL = 'middle_earth_auth_app.MiddleEarthUser'
